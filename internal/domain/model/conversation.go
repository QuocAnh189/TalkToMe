...
type Conversation struct {
	...
	UserIDOne     string          `gorm:"column:user_id_one;not null;uniqueIndex:idx_conversation_users"`
	UserIDTwo     string          `gorm:"column:user_id_two;not null;uniqueIndex:idx_conversation_users"`
